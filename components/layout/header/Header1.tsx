      ...
      >
        ...
        <div className="top-bar top-bar-2 top-bar-3 bg-transparent">
          <div className="container-fluid">
            <div className="text-header-info">
              <Link className="phone-head text-white" href="tel:+16156024555">
                <svg
                  width={16}
                  height={16}
                  viewBox="0 0 16 16"
              ...
              <Link
                className="email-head text-white"
            ...
            <div className="text-header">
              <div className="text-unlock text-sm-medium text-white">
                More than <span className="text-primary">800+</span> cars
                detailed last year.
              </div>

              {/* OPTIONAL: change this to your CTA (or remove it) */}
              <Link
        ...
        <div className="container-fluid">
          <div className="main-header">
            ...
            <div className="header-left">
              <div className="header-logo">
                <Link href="/" className="d-flex align-items-center gap-2">
                  ...
                  />
                  <span className="tagline">Cross Shine Car Detailing</span>
                </Link>
              </div>
            ...
            {/* RIGHT: BUTTONS + MOBILE BURGER (SIBLING OF header-left) */}
            <div className="header-right">
              {/* optional sign in (desktop only) */}
